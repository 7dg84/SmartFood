      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link
              to="/catalogo"
              className={`px-6 py-2 rounded transition-colors ${isActive('catalog')
                ? 'bg-[#16a249] text-white'
                : 'text-gray-700 hover:bg-gray-100'
                }`}
            >
            ...
            <Link
              to="/contenido"
              className={`px-6 py-2 rounded transition-colors ${isActive('content')
                ? 'bg-[#16a249] text-white'
                : 'text-gray-700 hover:bg-gray-100'
                }`}
            >
            ...
            <Link
              to="/feedback"
              className={`px-6 py-2 rounded transition-colors ${isActive('feedback')
                ? 'bg-[#16a249] text-white'
                : 'text-gray-700 hover:bg-gray-100'
                }`}
            >
